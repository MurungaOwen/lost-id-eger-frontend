...
export const Navbar: React.FC<NavbarProps> = ({ isOpen, toggleSidebar }) => {
    ...
    return (
        <>
            {/* Desktop Navigation */}
            {isOpen ? (
                <div className="bg-gray-50 w-44 text-green-600 fixed top-0 left-0 flex flex-col min-h-screen transition-transform duration-300 z-50">
                    ...
                    <div className="flex flex-col p-2 m-2 justify-center align-middle mt-44 font-semibold">
                        ...
                        <Link to="/contact" className="mt-5 hover:text-teal-900 flex space-x-4">
                            <SendIcon />
                            <div>Contact us</div>
                        </Link>
                ...
                <div className="bg-white sm:bg-gray-50 hidden w-14 text-green-600 fixed top-0 left-0 z-50 sm:flex flex-col min-h-screen transition-transform duration-300">
                    ...
                    <div className="flex flex-col p-2 m-2 justify-center align-middle mt-44 font-semibold">
                        ...
                        <Link to="/contact" className="mt-5 hover:text-teal-900"><SendIcon/></Link>
            ...
            {/* Mobile Navigation */}
            {!mobileNavOpen ? (
                <div className="rounded-full w-fit block sm:hidden text-green-600 sticky top-1 left-2 z-50">
